<script lang="ts">
	...
	import SeoContentSection from '$lib/components/SeoContentSection.svelte';
...
<div class="relative overflow-x-hidden">
	...
	<main id="main-content" class="relative z-20 bg-charcoal">
		...
		<section class="px-6 py-24 md:px-12 lg:px-20 xl:px-28">
			<div class="grid gap-16 md:grid-cols-[1fr_1.5fr] lg:grid-cols-[1fr_2fr]">
				...
				<div use:scrollReveal class="reveal reveal-left md:sticky md:top-24 md:self-start">
					...
					<h2
						class="font-display text-3xl font-bold tracking-tight text-white md:text-4xl lg:text-5xl"
					>
				...
				<div class="space-y-8">
					<div use:scrollReveal class="reveal reveal-right space-y-8 delay-1">
						<p class="max-w-[60ch] text-lg leading-relaxed text-brand-200 md:text-xl">
							Wir bei Evolve Grappling haben uns voll auf den Kampfsport Brazilian Jiu-Jitsu (BJJ)
							im Gi und No-Gi sowie auf Ringen f&uuml;r Grappling spezialisiert. Wir arbeiten an den
							Zielen und am Potenzial jedes Einzelnen als starkes Team zusammen, ob Wettk&auml;mpfer
							oder Hobbyist, Anf&auml;nger oder fortgeschrittener Grappler.
						</p>
						...
						<nav class="flex flex-wrap gap-x-8 gap-y-2 text-sm font-medium text-brand-400">
							<a
								href="#trainingsplan"
								class="underline underline-offset-4 transition-colors hover:text-accent-500"
								>Trainingsplan</a
							>
							<a
								href="#team"
					...
					<div class="grid gap-6 pt-8 md:grid-cols-3">
						...
						>
							...
							<p class="text-sm leading-relaxed text-brand-200">
								...
								zur&uuml;ck und bilden sich kontinuierlich fort.
							</p>
						</div>
						...
						>
							...
							<p class="text-sm leading-relaxed text-brand-200">
								...
								Training und Open Mats stattfinden.
							</p>
						</div>
					</div>
				</div>
		...
		<!-- Score-line divider -->
		<div class="mx-6 score-line md:mx-12 lg:mx-20 xl:mx-28"></div>
